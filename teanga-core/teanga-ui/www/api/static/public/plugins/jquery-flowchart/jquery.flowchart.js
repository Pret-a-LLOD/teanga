...
// "colorize" the widget name
    $.widget("flowchart.flowchart", {
        ...
        getOperatorCompleteData: function (operatorData) {
            ...
            // adding functionality by @housamz
            for (var connectorId_op in infos.options) {
                if (infos.options.hasOwnProperty(connectorId_op)) {
                    if (infos.options[connectorId_op] == null) {
                        delete infos.options[connectorId_op];
                    }
                }
            }
        ...
        _getOperatorFullElement: function (operatorData) {
            ...
            // adding functionality by @housamz
            var $operator_options = $('<div class="flowchart-operator-options"></div>');
            $operator_options.appendTo($operator);
        ...
        getOperatorOptions: function (operatorId) {
            return this.data.operators[operatorId].internal.properties.options;
        },
